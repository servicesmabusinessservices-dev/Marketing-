    ...
    public partial class AddNotificationsTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationId = table.Column<string>(type: "varchar(32)", maxLength: 32, nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_UserEmail_IsRead_CreatedAtUtc",
                table: "Notifications",
                columns: new[] { "UserEmail", "IsRead", "CreatedAtUtc" });
        }

...
public class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    ...
    private static string ResolveBasePath()
    {
        ...
        if (File.Exists(Path.Combine(currentDirectory, "GmailManager.Api.csproj")))
        {
            return currentDirectory;
        }

        var projectSubFolder = Path.Combine(currentDirectory, "GmailManager.Api");
        if (File.Exists(Path.Combine(projectSubFolder, "GmailManager.Api.csproj")))
        {
